...
from functions.save_file import save_file_asrows, save_df
import time
import pandas as pd
...
# %%
filename = "database/global_toadd.csv"
# %%
listAll = file_names.Inglaterra()
save_file_asrows(filename, listAll)
